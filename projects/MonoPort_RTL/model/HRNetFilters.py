...
if __name__ == "__main__":
    ...
    # MAC and PARAMS: 8.405092352 3.86072
    # 46.71 FPS, GPU_Utils 38%
    # model = HRNetV2_W18_small_v2().cuda()
    
    # MAC and PARAMS: 75.854495744 36.601776
    # 47.21 FPS, GPU_Utils 81%
    model = HRNetV2_W18_small_v2_balance().cuda()
    
    # MAC and PARAMS: 97.407860736 68.251816
    # 45.52 FPS, GPU_Utils 94%
    # model = HRNetV2_W18_small_v2_balance_v2().cuda()
    
    # MAC and PARAMS: 122.054230016 123.784256
    # 35.91 FPS, GPU_Utils 97%
    # model = HRNetV2_W18_small_v2_deeper().cuda()
    ...
    print ("MAC and PARAMS:", macs / 1e9, params / 1e6)
